class MemberAllocationsController < ApplicationController
  def index
    ...
    members = policy_scope(Member).players.asc
    members = members.from_year(@year_group.year_of_birth_from) unless @year_group.year_of_birth_from.nil?
    members = members.to_year(@year_group.year_of_birth_to) unless @year_group.year_of_birth_to.nil?
