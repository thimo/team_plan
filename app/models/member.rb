...
class Member < ApplicationRecord
  ...
  EXPORT_COLUMNS = %w[season age_group team association_number name full_name last_name first_name middle_name born_on role address zipcode city phone email member_since previous_team].freeze
