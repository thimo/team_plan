...
class Role < ApplicationRecord
  ...
  BEHEER_ROLES     = %w[BEHEER_ROLES BEHEER_GROUPS BEHEER_USERS BEHEER_MEMBERS
  ...
  ROLES = BEHEER_ROLES + DASHBOARD_ROLES + TEAM_ROLES + MEMBER_ROLES + AGE_GROUP_ROLES + SEASON_ROLES + COMMENT_ROLES +
          STATUS_ROLES + TEAM_MEMB_ROLES + PLAY_BAN_ROLES + INJURY_ROLES + TRAINING_ROLES + TRA_SCHED_ROLES + NOTE_ROLES
  ROLES.each do |role|
