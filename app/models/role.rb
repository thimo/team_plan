...
class Role < ApplicationRecord
  ...
  AGE_GROUP_ROLES = %w[AGE_GROUP_SHOW_EVALUATIONS AGE_GROUP_SHOW_TODOS AGE_GROUP_SHOW_MEMBER_COUNT
                       AGE_GROUP_TEAM_ACTIONS].freeze
  SEASON_ROLES    = %w[SEASON_TEAM_ACTIONS].freeze
